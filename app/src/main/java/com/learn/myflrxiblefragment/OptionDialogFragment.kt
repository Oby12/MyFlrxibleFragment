package com.learn.myflrxiblefragment
...
//sini kelas fragment yang kita buat inherit ke DialogFragment. Dengan begitu obyek fragment sekarang merupakan obyek dialog yang akan tampil mengambang di layar
class OptionDialogFragment : DialogFragment(){
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnChoose.setOnClickListener {
            ...
            //ini adlah penggunaan interface
    ...
    //nterface adalah sebuah kelas yang terdiri kumpulan method yang hanya memuat deklarasi dan struktur method, tanpa detail implementasinya.
